...
install_chart_releaser() {
  ...
  if [[ ! -d "$install_dir" ]]; then
    ...
    curl -sSLo "$install_dir/cr.tar.gz" "https://github.com/helm/chart-releaser/releases/download/$version/chart-releaser_${version#v}_${architecture}.tar.gz"
    tar -xzf "$install_dir/cr.tar.gz" -C "$install_dir"
    rm -f "$install_dir/cr.tar.gz"
  fi
